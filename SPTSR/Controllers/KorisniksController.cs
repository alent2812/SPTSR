...
namespace SPTSR.Controllers
{
    public class KorisniksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Ime,Prezime,Jmbag")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ime,Prezime,Jmbag")] Korisnik korisnik)
        {
            if (ModelState.IsValid)
            {
